...
public class ExemploIOObject {
    public static void serealizarObjeto() {
        ...
        Gato gato = new Gato("Jon", "tigrado", 19, true);
        ...
        try { //tente
            ...
            oos.writeObject(gato); //metódo que escreve no objeto
    ...
    public static void desserializarObjeto(String arquivo) {
        ...
        try { //tente
            ...
            Gato gatoComentado = (Gato) ois.readObject(); //método que lê o objeto serealizado
    ...
    public static void main (String[]args){
        //serealizarObjeto();
        desserializarObjeto("C:\\Users\\tatia\\Documents\\Java Exercises\\Dio\\gato");
    }
